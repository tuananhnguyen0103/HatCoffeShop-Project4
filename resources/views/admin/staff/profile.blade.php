                ...
                <div class="col-xl-4">
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-3">
                                        <h5 class="text-primary">Xin chào {{$staff->staff_name}}!</h5>
                                    </div>
                                </div>
                                <div class="col-5 align-self-end">
                                    <img src="{{ url('/') }}/uploads/image/banners/logo-tittle-2.jpg" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <img src="{{ url('/') }}/{{$staff->staff_image}}" alt="" class="img-thumbnail rounded-circle">
                                    </div>
                                    <h5 class="font-size-15 text-truncate">Chức vụ</h5>
                                    <p class="text-muted mb-0 text-truncate">{{$staff->staff_role}}</p>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-4">Chúc bạn có một ngày làm việc hiệu quả</p>
