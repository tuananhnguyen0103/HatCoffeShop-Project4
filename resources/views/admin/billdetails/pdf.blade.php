  ...
  <body>
    ...
    <table class="table table-nowrap table-hover mb-0">
        <thead>
            ...
            <tr>
                <th scope="col">#</th>
                <span><th scope="col">San Pham </th></span>
                <th scope="col"><span>Gia Ban(VND)</span></th>
                <th scope="col"><p>So Luong </p></th>
                <th scope="col"><p>Tong cong(VND)</p></th>
            </tr>
        </thead>
        <tbody>
    ...
    <div class="card-body">
        ...
        <p class="text-muted mb-5">Thong tin chi tiet: {{$Bill->bill_descriptions}}</p>
        <div class="table-responsive">
            <table class="table table-nowrap mb-0">
                <tbody>
                    <tr>
                        <th scope="row"> Ten Khach Hang:</th>
                    ...
                    <tr>
                        ...
                        @if ($Bill->bill_pay_day==null)
                            <tr>
                                <th scope="row">Ngay thanh toan :</th>
